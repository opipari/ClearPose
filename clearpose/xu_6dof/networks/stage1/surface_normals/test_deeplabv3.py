...
from clearpose.xu_6dof.networks.references.segmentation.train import evaluate
...
def main(save_dir=os.path.join("experiments","xu_6dof","stage1","surface_normals","models")):
	...
	data_loader = torch.utils.data.DataLoader(
		dataset, batch_size=9, drop_last=True, shuffle=True, num_workers=4)
	...
	model.load_state_dict(torch.load(os.path.join(save_dir,"deeplabv3_1.pt")))
