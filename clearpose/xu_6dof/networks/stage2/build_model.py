...
from clearpose.xu_6dof.networks.references.posenet.pspnet import PSPNet
from clearpose.xu_6dof.networks.references.posenet.utils import sample_rotations_60
